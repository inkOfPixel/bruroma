...
export type ComponentButtonCallToAction = {
  __typename?: 'ComponentButtonCallToAction';
  id: Scalars['ID'];
...
export type ComponentSectionHero = {
  ...
  callToAction?: Maybe<Array<Maybe<ComponentButtonCallToAction>>>;
...
export type ComponentSectionHeroInput = {
  title: Scalars['String'];
  description?: Maybe<Scalars['String']>;
  callToAction?: Maybe<Array<Maybe<ComponentButtonCallToActionInput>>>;
...
export type PageSectionsDynamicZone = ComponentSectionHero;
...
export type EditComponentButtonCallToActionInput = {
  id?: Maybe<Scalars['ID']>;
  title?: Maybe<Scalars['String']>;
...
export type EditComponentSectionHeroInput = {
  ...
  title?: Maybe<Scalars['String']>;
  description?: Maybe<Scalars['String']>;
  callToAction?: Maybe<Array<Maybe<EditComponentButtonCallToActionInput>>>;
  image?: Maybe<Scalars['ID']>;
};
...
export type GetPagesQuery = (
  ...
  & { pages?: Maybe<Array<Maybe<(
    { __typename?: 'Page' }
    & Pick<Page, 'id' | 'locale' | 'created_at' | 'updated_at' | 'title' | 'path'>
    & { sections?: Maybe<Array<Maybe<(
      { __typename: 'ComponentSectionHero' }
      & Pick<ComponentSectionHero, 'id' | 'title' | 'description'>
      & { callToAction?: Maybe<Array<Maybe<(
        { __typename?: 'ComponentButtonCallToAction' }
        & Pick<ComponentButtonCallToAction, 'id' | 'title' | 'url'>
      )>>>, image?: Maybe<(
        { __typename?: 'UploadFile' }
